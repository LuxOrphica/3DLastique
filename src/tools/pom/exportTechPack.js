...
function buildBOM(wb, bomItems, styleInfo, lang) {
  ...
  const cols = L ? [
    ...
    { header: "Расположение", width: 22 },
    { header: "Требование",   width: 22 },
    { header: "Параметр",     width: 16 },
    { header: "Кол-во",       width: 9  },
    { header: "Ед.",          width: 7  },
    ...
    { header: "Placement",    width: 22 },
    { header: "Requirement",  width: 22 },
    { header: "Parameter",    width: 16 },
    { header: "Qty",          width: 9  },
    { header: "Unit",         width: 7  },
  ...
  items.forEach(item => {
    ...
    tableRow(ws, r, [
      ...
      item.status || "",
      item.remarks || "",
    ], { center: [true, false, false, false, false, false, true, true, false, true, false] });
    r++;
  });
